...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2021 at 09:59 PM
...
(3, 'Urmi', 'Urmi@gmail.com', '$2y$10$NzurAA1BuST5HcB4.ux9bOhYv.08zvQcQfS9fseOXNYWJwLtbU0D.', '9hpdZl4OhP5ACsRIQnvaCXkn9cffKkNW3X0ueH88Fa7sp4j7IWvOTVYKDR4w', '2021-04-22 11:49:23', '2021-04-22 11:49:23');
...
(3, 3, NULL, 1, 'Ball Room', '20-50', '10k-30k');
...
INSERT INTO `meetings` (`id`, `customer_id`, `provider_id`, `scheduledtime`, `status`) VALUES
(1, 3, 4, '2021-05-28', 'Pending'),
(2, 3, 3, '2021-05-12', 'Approved');
...
(24, '2021_04_24_165058_create_meetings_table', 5),
(25, '2021_04_24_191634_create_messages_table', 6);
