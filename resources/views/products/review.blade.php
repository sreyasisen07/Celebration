...
<div class="card" style="width:70%; margin-right:25px; height:520px">
  <div class="card-body" >
  <br>
  <br>
  
  <div class="card" style="width:70%; margin-left:115px">
  <div class="card-header" style="background-color:#4f4cae ; color:white">
    Write your review
  </div>
  <div class="card-body">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="writereview">
   <br>
    <button type="submit" class="btn btn-primary" style="background-color:#4f4cae; color:white">Submit</button>
